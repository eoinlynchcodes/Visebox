...
<div class="content no-top-banner">
  <div class="content-header no-mg-top">
    ...
    <div class="content-header-title">Welcome :  <?php  echo $this->session->userdata('first_name');?></div>
        ...
        <div class="card">
          ...
          <div class="clear">
            <div class="card-title">
              <?php $user_count=get_contact_count();?>
              <span class="timer" data-from="0" data-to="<?php echo  $user_count->total;?>">
                <?php echo $user_count->total;?></span>
            </div>
            <div class="card-subtitle">Contact Us</div>
          </div>
        </div>
      </div>
      <div class="col-md-3 card-wrapper">
        <div class="card">
          ...
          <div class="clear">
            <div class="card-title">
               <?php $product_count=get_product_count();?>
              <span class="timer" data-from="0" data-to="<?php  echo $product_count->total;?>"><?php echo $product_count->total;?></span>
            </div>
