<div class="breadcrumb">Home <span class="breadcrumb-devider">/</span>Manage Group<span class="breadcrumb-devider">/</span> Modify<span class="breadcrumb-devider"></span> </div>
<div class="content">
  <div class="panel">
...
<?php 
	...
	$groups=get_groups();
//print'<pre>';print_r($group);die;?>
<?php echo form_open('group/admin/edit/'.$group->id) ?>
