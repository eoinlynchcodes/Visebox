<div class="container">
      <div class="row">
        <div class="col-md-12 margin-top-60">
          ...
          <h2 span class="vise-1">Mentor Login</h2>
    ...
    <span aria-hidden="true">&times;</span>
          ...
          <div class="login-form">
            <form action="<?php echo base_url('mentor-login');?>" method="POST" id="mentor_login" >
              ...
              <span class="reg"><a href="<?php echo base_url('mentor-register');?>">Register as a Mentor</a></span>
