  ...
  <aside class="side-nav">
   ...
   <div class="user-side-profile">
      <div class="user-image">
		...
		<?php $mentor_detail=get_mentor_detail();?>
        <img src="<?php echo base_url().'assets/upload/mentor_profile_image/'.$mentor_detail->image;?>"/>
      </div>
      <div class="clear">
        <div class="user-name"><?php echo $mentor_detail->first_name.' '.$mentor_detail->last_name;?></div>
