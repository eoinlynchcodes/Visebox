...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2017 at 02:50 PM
...
(4, 1, 'Economics', '150780773820171012.jpg', '1234', 'ABC', 'Noida', '8th Edition Used for Business at Dublin City University', 'Dublin City University', 'Business', 'Business', 1, '2017-10-12 11:29:28', '2017-10-12 11:28:58');
...
(3, 'TRUST OUR WORK', '149967250520170710.jpg', 'Speak to someone that has done what you aspire to.. ', '1', '2017-07-10 13:11:19', '2017-10-10 18:17:06'),
...
(5, 'We are the Happiness Sponsors', '149967397720170710.jpg', 'Speak to someone that has done what you aspire to.. ', '1', '2017-07-10 13:36:17', '2017-10-10 18:47:37');
...
INSERT INTO `tbl_mentors` (`mentor_id`, `country_id`, `city_id`, `university_id`, `course_id`, `category_id`, `fullname`, `first_name`, `last_name`, `email`, `phone_no`, `password`, `bio`, `description`, `image`, `status`, `ip_address`, `last_login`, `created_on`, `updated_on`) VALUES
(3, 3, 2, 2, NULL, 9, 'Sevastian Test', 'Sevastian', 'Test', 'rakesh1@gmail.com', '8090090795', '3c5a3cd0763f9b56b2342bce027e2f7d', 'rakesh@gmail.com', 'rakesh@gmail.com', 'profile.jpg', 0, '::1', '1507530946', '2017-10-11 07:03:15', '0000-00-00 00:00:00'),
(5, 3, 2, 2, NULL, 9, 'Vinay Gupta', 'Vinay', 'Gupta', 'mentor@gmail.com', '8090090795', '827ccb0eea8a706c4c34a16891f84e7b', 'AIT fourth year. BSc(Honours) in Biotechnology. Have helped out students in my class, all of which are in the same year as me.', 'AIT fourth year. BSc(Honours) in Biotechnology. Have helped out students in my class, all of which are in the same year as me.', 'profile.jpg', 1, '::1', '1507531237', '2017-10-12 05:47:15', '0000-00-00 00:00:00');
...
INSERT INTO `tbl_mentor_module` (`id`, `mentor_id`, `mentorship_id`, `module_id`, `status`) VALUES
(37, 5, 3, 1, 0),
(38, 5, 3, 2, 0),
(40, 5, 4, 4, 0);
...
INSERT INTO `tbl_module` (`id`, `category_id`, `module_name`, `status`, `created_on`, `updated_on`) VALUES
(1, 9, 'Criket', 1, '2017-10-06 08:36:37', '2017-10-06 08:36:37'),
(2, 9, 'Hockey', 1, '2017-10-06 08:37:06', '2017-10-06 08:37:06'),
(3, 8, 'Painting', 1, '2017-10-11 07:27:58', '0000-00-00 00:00:00'),
(4, 7, 'Driving', 1, '2017-10-11 07:28:10', '0000-00-00 00:00:00'),
(5, 8, 'Singging', 1, '2017-10-11 07:28:23', '0000-00-00 00:00:00');
...
INSERT INTO `tbl_mymentorship` (`id`, `mentor_id`, `title`, `slug`, `price`, `category_id`, `description`, `op_msg`, `image`, `seen`, `status`, `created_on`, `updated_on`) VALUES
(3, 5, 'Test', 'test-vinay-gupta', 7, 9, '<p>AIT fourth year. BSc(Honours) in Biotechnology. Have helped out students in my class, all of which are in the same year as me.</p>\n', 'good2\r\n', '150763284020171010.jpg', 0, 1, '2017-10-10 16:05:44', '2017-10-10 17:59:42'),
(4, 5, 'Test2', 'test2-vinay-gupta', 100, 7, '<p>goodd</p>\r\n', 'good', '150770666020171011.jpg', 0, 1, '2017-10-11 12:54:20', '2017-10-11 12:58:42');
...
(1, '127.0.0.1', 'Vinay Gupta', 'Vinay', 'Gupta', 'student@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '', 2, 0, 0, 0, NULL, '8090090795', NULL, NULL, 1, 'GvNm7sTawgKjWw3snS8tmO', 1486022560, 1447915390),
